...
inputCardHolder.addEventListener("keypress", function(a){
    if(!checkCharName(a)){
        a.preventDefault();
    }
});	
...
inputCardNumber.addEventListener("keypress", function(b){
...
inputMM.addEventListener("keypress", function(c){
    if(!checkCharMM(c)){	
        c.preventDefault();
    }
});
...
inputYY.addEventListener("keypress", function(d){
    if(!checkCharYY(d)){
        d.preventDefault();
    }
});
